...
# Midnight Night Coin (NIGHT) Token Constants
NIGHT_COIN_NAME = "Night Coin"
NIGHT_COIN_SYMBOL = "NIGHT"
NIGHT_COIN_ENTRY_STAKE = 10
NIGHT_COIN_WIN_REWARD = 50
NIGHT_COLOR_COIN = (255, 215, 0)